  ...
  return (
    ...
    <div className='w-full flex flex-col items-center'>
      <div className='w-full sm:w-3/4 md:w-2/3 lg:w-1/2 xl:w-1/3 flex flex-col sm:flex-row justify-start items-center gap-4 p-4'>
        ...
        {/*
        <input type='text' id='userInput' className='h-11 w-full sm:w-72 rounded-3xl text-slate-500 p-4 text-xl' placeholder='Deine Stadt...' onKeyDown={(e) =>{
          if(e.key === "Enter"){
        ...
        */}
        ...
        <div className='flex justify-between items-center w-full sm:w-72 bg-white h-11 rounded-3xl text-xl text-slate-500 '>
          <input type='text' id='userInput' className='rounded-3xl pl-4 focus:outline-none w-full' placeholder='Deine Stadt...' onKeyDown={(e) =>{
            if(e.key === "Enter"){
              fetchGeoData(e.target.value)
            }
          }}></input>
